...
echo "Fixing API Gateway Response configurations for API: $API_ID"
echo "================================================================"
...
for RESPONSE_TYPE in "${!RESPONSE_CONFIGS[@]}"; do
    ...
    # Create new with wildcard origin
...
aws apigateway create-deployment \
    --rest-api-id "$API_ID" \
    --stage-name prod \
    --description "Fixed CORS origin to wildcard for teckstart.com migration" \
    --output json
